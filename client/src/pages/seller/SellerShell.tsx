...
export default function SellerShell({ children, title, breadcrumbs }: SellerShellProps) {
  ...
  return (
    <div className="flex h-screen w-full max-w-[100vw] overflow-hidden bg-[#F4F5F7] dark:bg-[#000000] text-neutral-900 dark:text-white transition-colors duration-200">
